...
INSERT INTO `product` VALUES ('AV-CB-01','BIRDS','Amazon Parrot','<image src=\"image/bird2.gif\">Great companion for up to 75 years'),('AV-SB-02','BIRDS','Finch','<image src=\"image/bird1.gif\">Great stress reliever'),('FI-FW-01','FISH','Koi','<image src=\"image/fish3.gif\">Fresh Water fish from Japan'),('FI-FW-02','FISH','Goldfish','<image src=\"image/fish2.gif\">Fresh Water fish from China'),('FI-SW-01','FISH','Angelfish','<image src=\"image/fish1.jpg\">Salt Water fish from Australia'),('FI-SW-02','FISH','Tiger Shark','<image src=\"image/fish4.gif\">Salt Water fish from Australia'),('FL-DLH-02','CATS','Persian','<image src=\"image/cat1.gif\">Friendly house cat, doubles as a princess'),('FL-DSH-01','CATS','Manx','<image src=\"image/cat3.gif\">Great for reducing mouse populations'),('K9-BD-01','DOGS','Bulldog','<image src=\"image/dog2.gif\">Friendly dog from England'),('K9-CW-01','DOGS','Chihuahua','<image src=\"image/dog4.gif\">Great companion dog'),('K9-DL-01','DOGS','Dalmation','<image src=\"image/dog5.gif\">Great dog for a Fire Station'),('K9-PO-02','DOGS','Poodle','<image src=\"image/dog6.gif\">Cute dog from France'),('K9-RT-01','DOGS','Golden Retriever','<image src=\"image/dog1.gif\">Great family dog'),('K9-RT-02','DOGS','Labrador Retriever','<image src=\"image/dog5.gif\">Great hunting dog'),('RP-LI-02','REPTILES','Iguana','<image src=\"image/lizard2.gif\">Friendly green friend'),('RP-SN-01','REPTILES','Rattlesnake','<image src=\"image/lizard3.gif\">Doubles as a watch dog');
...
-- Dump completed on 2020-04-02 14:46:44

    ...
    <div id="MainImage">
        <div id="MainImageContent">
            <map name="estoremap">
                ...
                <area alt="Fish" coords="2,180,72,250" href="Category?categoryId=FISH" shape="rect" />
                <area alt="Dogs" coords="60,250,130,320" href="Category?categoryId=DOGS" shape="rect" />
                <area alt="Reptiles" coords="140,270,210,340" href="Category?categoryId=REPTILES" shape="rect" />
                <area alt="Cats" coords="225,240,295,310" href="Category?categoryId=CATS" shape="rect" />
                <area alt="Birds" coords="280,180,350,250" href="Category?categoryId=BIRDS" shape="rect" />
            </map>
